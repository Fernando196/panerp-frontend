...
import type { EstadoProduccion } from '~/types/produccion.type'
...
const estados: { value: EstadoProduccion; label: string; activeClass: string }[] = [
  { value: 'planificada', label: 'Planificada', activeClass: 'border-muted/50 bg-muted-bg text-subtle' },
  { value: 'en_proceso', label: 'En proceso', activeClass: 'border-info/50 bg-info/10 text-info' },
  { value: 'completada', label: 'Completada', activeClass: 'border-success/50 bg-success/10 text-success' },
